...
$o1 = new MBOpenTOAuth( MB_AKEY , MB_SKEY  );
$keys = $o1->getRequestToken('http://it.haitianyuan.com/teacher/zp/php-sdk/test.php');//这里填上你的回调URL
$aurl = $o1->getAuthorizeURL( $keys['oauth_token'] ,false,'');
$_SESSION['keys'] = $keys;

echo 'Yes<br/>';

$o2 = new MBOpenTOAuth( MB_AKEY , MB_SKEY , $_SESSION['keys']['oauth_token'] , $_SESSION['keys']['oauth_token_secret']  );
$last_key = $o2->getAccessToken(  $_REQUEST['oauth_verifier'] ) ;//获取ACCESSTOKEN
